// This component displays a single tutorial preview.
export default function TutorialCard({ title, description, author, rating }) {
  return (
    <div className="border p-4 w-64 bg-white shadow rounded">
      ...
      <div className="h-32 bg-gray-200 mb-4 flex items-center justify-center">
        <span className="text-sm text-gray-500">Tutorial image</span>
      </div>
